...
The authenticated user's profile: username, account creation date, the list of
partidas they own, and an optional avatar image stored in Azure Blob Storage.
