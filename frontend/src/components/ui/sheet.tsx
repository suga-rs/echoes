...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-y-0 left-0 z-50 flex h-full w-72 flex-col border-r bg-background shadow-xl data-[state=open]:animate-slide-in-left",
        className
      )}
      {...props}
    >
...
export { Sheet, SheetTrigger, SheetClose, SheetPortal, SheetContent, SheetHeader, SheetTitle };
